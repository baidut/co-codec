...
**
** $Id: NoCompressionScan.cpp,v 1.33 2012-09-23 14:10:12 thor Exp $
**
*/

/// Includes
#include "codestream/nocompressionscan.hpp"
...
/// NoCompressionScan::NoCompressionScan
NoCompressionScan::NoCompressionScan(class Frame *frame,class Scan *scan,
...
/// NoCompressionScan::~NoCompressionScan
NoCompressionScan::~NoCompressionScan(void)
{
}
///

/// NoCompressionScan::StartParseScan
void NoCompressionScan::StartParseScan(class ByteStream *io,class BufferCtrl *ctrl)
{ 
...
/// NoCompressionScan::StartWriteScan
void NoCompressionScan::StartWriteScan(class ByteStream *io,class BufferCtrl *ctrl)
{ 
  class ACTemplate *ac,*dc;
  int i;
...
/// NoCompressionScan::StartMeasureScan
// Measure scan statistics.
void NoCompressionScan::StartMeasureScan(class BufferCtrl *)
{ 
  //
  // This is not required.
  JPG_THROW(NOT_IMPLEMENTED,"NoCompressionScan::StartMeasureScan",
	    "arithmetic coding is always adaptive and does not require "
	    "to measure the statistics");
}
///

/// NoCompressionScan::StartMCURow
// Start a MCU scan. Returns true if there are more rows.
bool NoCompressionScan::StartMCURow(void)
{
  bool more = StartRow();
...
/// NoCompressionScan::Restart
// Restart the parser at the next restart interval
void NoCompressionScan::Restart(void)
{
  int i;
...
/// NoCompressionScan::Classify
// Find the DC context class depending on the previous DC and
// the values of L and U given in the conditioner.
struct NoCompressionScan::QMContextSet::DCContextZeroSet &NoCompressionScan::QMContextSet::Classify(LONG diff,UBYTE l,UBYTE u)
{
...
/// NoCompressionScan::EncodeBlock
// Encode a single huffman block
void NoCompressionScan::EncodeBlock(const LONG *block,
...
/// NoCompressionScan::DecodeBlock
// Decode a single huffman block.
void NoCompressionScan::DecodeBlock(LONG *block,
				   LONG &prevdc,LONG &prevdiff,
				   UBYTE small,UBYTE large,UBYTE kx,UBYTE dc,UBYTE ac)
{
  // DC coding
  if (m_ucScanStart == 0 && m_bResidual == false) {
	...
	while(m_Coder.Get(m_Context[dc].DCMagnitude.X[i])) {
	  ...
	  i++;
	  if (m == 0) 
	    JPG_THROW(MALFORMED_STREAM,"NoCompressionScan::DecodeBlock",
...
/// NoCompressionScan::WriteFrameType
// Write the marker that indicates the frame type fitting to this scan.
void NoCompressionScan::WriteFrameType(class ByteStream *io)
{
...
/// NoCompressionScan::Flush
// Flush the remaining bits out to the stream on writing.
void NoCompressionScan::Flush(bool)
{
  int i;
...
/// NoCompressionScan::GetRow
// Return the data to process for component c. Will be overridden
// for residual scan types.
class QuantizedRow *NoCompressionScan::GetRow(UBYTE idx) const
{
  return m_pBlockCtrl->CurrentQuantizedRow(idx);
}
///

/// NoCompressionScan::StartRow
bool NoCompressionScan::StartRow(void) const
{
